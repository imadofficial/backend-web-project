...
<div style="padding: 40px 0;">
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 30px;">
        <div>
            <h1 style="font-size: 32px; margin-bottom: 10px; margin-top: 0;">Create New FAQ</h1>
            <p style="color: #666; margin: 0;">Add a new frequently asked question.</p>
        </div>
        ...
        <form action="/admin/faq" method="POST">
            ...
            <div style="margin-bottom: 20px;">
                ...
                <textarea id="answer" 
                          ...
                          style="width: 100%; padding: 12px; border: 1px solid #e0e0e0; border-radius: 8px; font-size: 14px; box-sizing: border-box; resize: vertical;">{{ old('answer') }}</textarea>
            </div>
